...
@section('contenido')
    ...
    <header class="flex flex-col md:flex-row md:items-center mb-6 gap-4">
        <div>
            <h2 class="text-2xl font-bold text-gray-800">Gestión de Usuarios y Seguridad</h2>
        </div>
    </header>
    ...
    <div class=" rounded-xl overflow-hidden p-4">
        ...
        <section class="mb-10">
            ...
            <!-- Auditoria -->
            <section class="mb-10">
                <h2 class="text-2xl font-bold mb-4 text-indigo-800 border-b pb-2">Auditoría</h2>
                <div class="bg-white p-6 rounded-lg shadow-md">
                    ...
                    {{-- Lista de auditorías con nuevo diseño --}}
                        ...
                        @forelse ($auditorias as $item)
                            <div class="py-3 flex items-start gap-3">
                                ...
                                @php
                                    ...
                                    $iconClass = $iconColors[$item->accion] ?? 'bg-gray-100 text-gray-600';
                                @endphp
                                <div
                                    class="w-8 h-8 rounded-full {{ $iconClass }} flex items-center justify-center flex-shrink-0">
                                    @switch($item->accion)
                                        @case('crear')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <form action="{{ route('salarios.excel') }}" method="GET">
                                ...
                                <button type="submit"
                                    class="bg-green-600 text-white py-2 px-4 rounded hover:bg-green-700 cursor-pointer transition active:scale-90">Generar
                                    Reporte
                                    Contable</button>
