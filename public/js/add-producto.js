...
if (boton) {
    boton.addEventListener("click", (e) => {                
        ...
        fetch('http://127.0.0.1:8000/agregar-producto', {
            method: 'POST',
            headers: {
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function addMarca() {
        ...
        fetch('http://127.0.0.1:8000/agregar-marca', {
            method: 'POST',
            headers: {
    ...
    function addCategoria() {
        ...
        fetch('http://127.0.0.1:8000/agregar-categoria', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRF-TOKEN': csrfToken
    ...
    function addDistribuidor() {
        ...
        fetch('http://127.0.0.1:8000/agregar-distribuidor', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
...
document.getElementById('query').addEventListener('input', function () {
    ...
    debounceTimer = setTimeout(() => {
        ...
        fetch(`http://127.0.0.1:8000/api/distribuidores?q=${encodeURIComponent(query)}`, {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRF-TOKEN': csrfToken
...
cerrarq.addEventListener('click', () => {
    ...
    fetch('http://127.0.0.1:8000/api/distribuidores?q=', {
        method: 'GET',
        headers: {
            'Content-Type': 'application/json',
            'X-CSRF-TOKEN': csrfToken
...
document.getElementById('import-form').addEventListener('submit', async (e) => {
    ...
    try {
        const res = await fetch('http://127.0.0.1:8000/api/import-products', {
            method: 'POST',
            headers: {
                'X-CSRF-TOKEN': csrfToken,
            },
